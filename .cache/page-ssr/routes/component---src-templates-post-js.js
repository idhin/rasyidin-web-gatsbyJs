...
class Comments extends (/* unused pure expression or super */ null && (Component)){constructor(props){super(props);this.onSubmitComment=async event=>{event.preventDefault();this.setState({submitting:true});const{newComment,comments}=this.state;const{slug}=this.props;const response=await fetch(config.commentsApi,{headers:{Accept:'application/json','Content-Type':'application/json'},method:'post',body:JSON.stringify(newComment)});if(response.status===201){this.setState(prevState=>({...prevState,comments:[newComment,...comments],newComment:{name:'',parentCommentId:'',text:'',slug},success:true,error:false}));}else{this.setState({...this.initialState,error:true});}};this.handleChange=event=>{const{newComment}=this.state;const{name,value}=event.target;this.setState({newComment:{...newComment,[name]:value}});};this.initialState={submitting:false,comments:[],newComment:{name:'',parentCommentId:'',text:'',slug:this.props.slug},success:false,error:false};this.state=this.initialState;}componentDidUpdate(prevProps){const{commentsList}=this.props;if(prevProps.commentsList!==commentsList&&commentsList.length>0){this.setState({comments:commentsList});}}render(){const{submitting,success,error,comments,newComment:{name,text}}=this.state;const showError=()=>error&&/*#__PURE__*/React.createElement("blockquote",{className:"error"},/*#__PURE__*/React.createElement("p",null,"Comments disabled."));const showSuccess=()=>success&&/*#__PURE__*/React.createElement("blockquote",{className:"success"},/*#__PURE__*/React.createElement("p",null,"Comment submitted!"));const commentTitle=commentLength=>{if(commentLength<1){return'Leave a comment';}else if(commentLength===1){return'1 comment';}else{return`${commentLength} comments`;}};return/*#__PURE__*/React.createElement("section",{className:"comments",id:"comments"},success||error?showError()||showSuccess():/*#__PURE__*/React.createElement(React.Fragment,null,/*#__PURE__*/React.createElement("h3",null,commentTitle(comments.length)),/*#__PURE__*/React.createElement("form",{id:"new-comment",onSubmit:this.onSubmitComment},/*#__PURE__*/React.createElement("input",{type:"text",name:"name",id:"name",value:name,onChange:this.handleChange,minLength:"3",maxLength:"255",placeholder:"Name",required:true}),/*#__PURE__*/React.createElement("textarea",{rows:"2",cols:"5",name:"text",id:"text",value:text,onChange:this.handleChange,minLength:"20",maxLength:"1000",placeholder:"Comment",required:true}),/*#__PURE__*/React.createElement("div",{style:{marginBottom:'.5rem'}},/*#__PURE__*/React.createElement("small",null,"Plain text only. Comment must be over 20 characters.")),/*#__PURE__*/React.createElement("button",{type:"submit",disabled:!name||!text||text.length<20||submitting},"Submit"))),comments.length>0&&comments.filter(comment=>!comment.parent_comment_id).filter((comment,i)=>i<50).map((comment,i)=>{let child;if(comment.id){child=comments.find(c=>comment.id==c.parent_comment_id);}return/*#__PURE__*/React.createElement("div",{className:"comment",key:i,"data-id":i},/*#__PURE__*/React.createElement("header",null,/*#__PURE__*/React.createElement("h2",null,comment.name),/*#__PURE__*/React.createElement("div",{className:"comment-date"},moment(comment.date).fromNow())),/*#__PURE__*/React.createElement("p",null,comment.text),child&&/*#__PURE__*/React.createElement("div",{className:"comment reply"},/*#__PURE__*/React.createElement("header",null,/*#__PURE__*/React.createElement("h2",null,child.name),/*#__PURE__*/React.createElement("div",{className:"comment-date"},moment(child.date).fromNow())),/*#__PURE__*/React.createElement("p",null,child.text)));}));}}
// EXTERNAL MODULE: ./node_modules/lodash.kebabcase/index.js
var lodash_kebabcase = __webpack_require__(5683);
var lodash_kebabcase_default = /*#__PURE__*/__webpack_require__.n(lodash_kebabcase);
;// CONCATENATED MODULE: ./src/components/PostTags.js
class PostTags extends index_js_.Component{render(){const{tags,size}=this.props;return/*#__PURE__*/index_js_default().createElement("div",{className:"tag-container"},tags&&tags.map(tag=>/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{key:tag,style:{textDecoration:'none'},to:`/tags/${lodash_kebabcase_default()(tag)}/`},/*#__PURE__*/index_js_default().createElement("span",{className:size},tag))));}}
// EXTERNAL MODULE: ./src/components/SEO.js
var SEO = __webpack_require__(8454);
// EXTERNAL MODULE: ./src/utils/global.js
var global = __webpack_require__(838);
// EXTERNAL MODULE: ./content/images/tania2020crop.jpg
var tania2020crop = __webpack_require__(2675);
;// CONCATENATED MODULE: ./src/templates/post.js
class PostTemplate extends index_js_.Component{render(){const{slug}=this.props.pageContext;const postNode=this.props.data.markdownRemark;const post=postNode.frontmatter;let thumbnail;if(!post.id){post.id=slug;}if(!post.category_id){post.category_id=(SiteConfig_default()).postDefaultCategoryID;}if(post.thumbnail){thumbnail=post.thumbnail.childImageSharp.fixed;}const date=(0,global/* formatDate */.p)(post.date);const githubLink=(0,global/* editOnGithub */.q)(post);const twitterShare=`https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=${(SiteConfig_default()).siteUrl}/${post.slug}&display=popup`;// const twitterShare = `http://twitter.com/share?text=${encodeURIComponent(post.title)}&url=${
//   config.siteUrl
// }/${post.slug}/&via=taniarascia`
return/*#__PURE__*/index_js_default().createElement(layout/* default */.Z,null,/*#__PURE__*/index_js_default().createElement(Helmet["default"],null,/*#__PURE__*/index_js_default().createElement("title",null,`${post.title} – ${(SiteConfig_default()).siteTitle}`)),/*#__PURE__*/index_js_default().createElement(SEO/* default */.Z,{postPath:slug,postNode:postNode,postSEO:true}),/*#__PURE__*/index_js_default().createElement("article",{className:"single container"},/*#__PURE__*/index_js_default().createElement("header",{className:`single-header ${!thumbnail?'no-thumbnail':''}`},thumbnail&&/*#__PURE__*/index_js_default().createElement(gatsby_image/* default */.Z,{fixed:post.thumbnail.childImageSharp.fixed}),/*#__PURE__*/index_js_default().createElement("div",{className:"flex"},/*#__PURE__*/index_js_default().createElement("h1",null,post.title),/*#__PURE__*/index_js_default().createElement("div",{className:"post-meta"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/me"},/*#__PURE__*/index_js_default().createElement("img",{src:tania2020crop/* default */.Z,className:"avatar-small",alt:"Tania"})),/*#__PURE__*/index_js_default().createElement("time",{className:"date"},date),"/",/*#__PURE__*/index_js_default().createElement("a",{className:"twitter-link",href:twitterShare,target:"_blank",rel:"noopener noreferrer"},"Share"),"/"),/*#__PURE__*/index_js_default().createElement(PostTags,{tags:post.tags}))),/*#__PURE__*/index_js_default().createElement("div",{className:"post",dangerouslySetInnerHTML:{__html:postNode.html}})));}}/* eslint no-undef: "off" */const pageQuery="1368877950";
...
var http = _interopDefault(__webpack_require__(6210));
var Url = _interopDefault(__webpack_require__(2470));
var whatwgUrl = _interopDefault(__webpack_require__(7347));
var https = _interopDefault(__webpack_require__(8308));
