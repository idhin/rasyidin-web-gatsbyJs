...
class TagsPage extends react__WEBPACK_IMPORTED_MODULE_0__.Component{render(){const{group}=this.props.data.allMarkdownRemark;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layout__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_SEO__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_1__.Helmet,{title:`Tags – ${(_data_SiteConfig__WEBPACK_IMPORTED_MODULE_6___default().siteTitle)}`}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"container"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",null,"Tags"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"tag-container"},group.map(tag=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_2__.Link,{to:`/tags/${lodash_kebabcase__WEBPACK_IMPORTED_MODULE_3___default()(tag.fieldValue)}`},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{key:tag.fieldValue},tag.fieldValue," ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong",{className:"count"},tag.totalCount)))))));}}const pageQuery="3311875502";
